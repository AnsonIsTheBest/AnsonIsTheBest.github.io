...
ChatTextBox=function(_preact$Component3){function ChatTextBox(){var _this9;for(var _len3=arguments.length,args=new Array(_len3),_key3=0;_key3<_len3;_key3++){args[_key3]=arguments[_key3];}_this9=_preact$Component3.call.apply(_preact$Component3,[this].concat(args))||this;_this9.
...
ChatPanel=function(_PSRoomPanel){function ChatPanel(){var _this10;for(var _len4=arguments.length,args=new Array(_len4),_key4=0;_key4<_len4;_key4++){args[_key4]=arguments[_key4];}_this10=_PSRoomPanel.call.apply(_PSRoomPanel,[this].concat(args))||this;_this10.
...
preact.h(TeamForm,{onSubmit:this.makeChallenge,defaultFormat:defaultFormat},
...
ChatLog=function(_preact$Component5){function ChatLog(){var _this12;for(var _len5=arguments.length,args=new Array(_len5),_key5=0;_key5<_len5;_key5++){args[_key5]=arguments[_key5];}_this12=_preact$Component5.call.apply(_preact$Component5,[this].concat(args))||this;_this12.



subscription=null;return _this12;}_inheritsLoose(ChatLog,_preact$Component5);var _proto7=ChatLog.prototype;_proto7.
