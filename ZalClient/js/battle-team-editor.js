...
TeamEditor=function(_preact$Component){function TeamEditor(){var _this3;for(var _len=arguments.length,args=new Array(_len),_key3=0;_key3<_len;_key3++){args[_key3]=arguments[_key3];}_this3=_preact$Component.call.apply(_preact$Component,[this].concat(args))||this;_this3.
...
TeamTextbox=function(_preact$Component2){function TeamTextbox(){var _this5;for(var _len2=arguments.length,args=new Array(_len2),_key4=0;_key4<_len2;_key4++){args[_key4]=arguments[_key4];}_this5=_preact$Component2.call.apply(_preact$Component2,[this].concat(args))||this;_this5.
...
_this5.props.onChange==null||_this5.props.onChange();
}
...
TeamWizard=function(_preact$Component3){function TeamWizard(){var _this8;for(var _len3=arguments.length,args=new Array(_len3),_key5=0;_key5<_len3;_key5++){args[_key5]=arguments[_key5];}_this8=_preact$Component3.call.apply(_preact$Component3,[this].concat(args))||this;_this8.
...
StatForm=function(_preact$Component4){function StatForm(){var _this11;for(var _len4=arguments.length,args=new Array(_len4),_key6=0;_key6<_len4;_key6++){args[_key6]=arguments[_key6];}_this11=_preact$Component4.call.apply(_preact$Component4,[this].concat(args))||this;_this11.
...
if(_this11.maxEVs()<6*252||_this11.props.editor.isLetsGo){
set.evs||(set.evs={});
}else{
...
DetailsForm=function(_preact$Component5){function DetailsForm(){var _this13;for(var _len5=arguments.length,args=new Array(_len5),_key7=0;_key7<_len5;_key7++){args[_key7]=arguments[_key7];}_this13=_preact$Component5.call.apply(_preact$Component5,[this].concat(args))||this;_this13.
